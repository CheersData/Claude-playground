---
title: "EU AI Act e contratti: cosa cambia da agosto 2026 per consumatori e PMI"
slug: eu-ai-act-contratti-obblighi-2026
meta_description: "L'EU AI Act entra in vigore ad agosto 2026. Scopri gli obblighi per aziende e PMI sui contratti, i nuovi diritti dei consumatori e come prepararti alla normativa europea sull'intelligenza artificiale."
keyword: EU AI Act obblighi aziende contratti
secondary_keywords:
  - AI Act agosto 2026
  - intelligenza artificiale contratti
  - obblighi PMI AI
  - diritto spiegazione AI
  - Regolamento UE 2024/1689
  - alto rischio intelligenza artificiale
type: pillar
status: draft
...
internal_links:
  - slug: contratto-scritto-da-ai-validita
    ...
    context: "Quando si parla di contratti generati da intelligenza artificiale"
  - slug: clausole-illegali-contratto-lavoro
    anchor: "clausole illegali nel contratto di lavoro"
    context: "Quando si menzionano obblighi HR e selezione personale"
  - slug: contratto-affitto-clausole-vietate
    anchor: "clausole vietate nel contratto di affitto"
    context: "Quando si parla di contratti di locazione e scoring inquilini"
  - slug: patto-non-concorrenza-lavoro
    anchor: "patto di non concorrenza"
    context: "Nel contesto dei contratti di lavoro e AI nella gestione HR"
---
...
Se sei un consumatore, hai nuovi diritti. Se sei una PMI, hai nuovi **obblighi aziende contratti** da rispettare. In entrambi i casi, ignorare questa normativa puo costare caro.

## Cos'e l'EU AI Act (spiegato semplice)

Il Regolamento UE 2024/1689 classifica i sistemi di intelligenza artificiale in base al **rischio** che rappresentano per i cittadini. Piu il rischio e alto, piu le regole sono stringenti.

La logica e a piramide:

| Livello | Cosa succede | Esempio |
|---------|-------------|---------|
| **Vietato** | L'AI non puo essere usata | Manipolazione subliminale, social scoring |
| **Alto rischio** | Obblighi pesanti: documentazione, supervisione, spiegazione | AI che decide se darti un mutuo o assumerti |
...
Il punto chiave per chi si occupa di contratti: molti sistemi AI usati nella vita quotidiana -- dalla valutazione del credito alla selezione del personale, dal pricing assicurativo allo scoring degli inquilini -- rientrano nella categoria **alto rischio**.

## Il calendario: cosa e gia in vigore e cosa arriva

L'AI Act non e scattato tutto insieme. L'implementazione e graduale:
...
Qui la questione si fa concreta. L'**Allegato III** del Regolamento elenca le attivita che rendono un sistema AI ad alto rischio. Molte PMI usano gia strumenti che rientrano in questa categoria senza saperlo:
...
2. **Assegnare personale competente** per la supervisione umana
3. **Verificare che i dati** forniti all'AI siano pertinenti e rappresentativi
4. **Monitorare il funzionamento** e segnalare rischi
5. **Conservare i log** per almeno **6 mesi**
6. **Informare i lavoratori** prima di usare AI sul posto di lavoro
...
**Esempio pratico -- contratto di consumo:** compri un'assicurazione online. Il premio e calcolato da un algoritmo, il contratto e generato automaticamente, l'assistenza post-vendita e un chatbot. Con l'AI Act, ognuno di questi passaggi ha obblighi specifici di trasparenza. E se il [contratto e stato scritto da un'AI](/blog/contratto-scritto-da-ai-validita), i rischi di clausole sbilanciate aumentano.
...
- **Rivedi i contratti** che la tua azienda propone ai clienti: se contengono clausole generate o influenzate da AI, verifica che siano conformi. Un'analisi automatica puo evidenziare [clausole vietate nei contratti di affitto](/blog/contratto-affitto-clausole-vietate) o squilibri contrattuali che un algoritmo potrebbe aver introdotto
