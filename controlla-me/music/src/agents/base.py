"""Base agent interface for the music analysis pipeline."""
...
class BaseAgent(ABC):
    """
    Abstract base class for all music analysis agents.

    Each agent in the pipeline:
    1. Reads input (audio file, previous agent output, or external API)
