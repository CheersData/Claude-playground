...
import type { BlogArticle, ArticleSection } from "@/app/blog/articles";
        ...
        >
          ...
          <ul className="space-y-2.5 pl-1">
            {section.items?.map((item, i) => (
              <li
                key={i}
                className="flex gap-3 text-sm text-foreground-secondary leading-relaxed"
              >
...
export default function PoimandresArticleDetailClient({
  article,
}: {
  article: BlogArticle;
}) {
        ...
        <div className="max-w-[720px] mx-auto">
          ...
          >
            ...
            <p className="text-foreground-secondary text-sm leading-relaxed max-w-[440px] mx-auto mb-6">
              ...
              analizzeranno in meno di 60 secondi. Le prime 3 analisi sono
              gratuite.
            </p>
            <Link
              href="https://controlla.me"
