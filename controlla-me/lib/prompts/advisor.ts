...
Rispondi SOLO con JSON valido (no markdown):
{
  ...
  "risks": [{
    ...
    "detail": "Spiegazione chiara in 2-3 frasi. Cita norma e sentenza spiegandole in parole semplici.",
...
Non essere allarmista se il documento è buono. Azioni concrete e ordinate per priorità. needsLawyer=true solo per problemi seri.`;
