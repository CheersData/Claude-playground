...
export function expandQuery(query: string): string[] {
  ...
  const formalMap: Record<string, string> = {
    ...
    "licenziato": "licenziamento risoluzione rapporto lavoro giusta causa giustificato motivo",
    "dimissioni": "dimissioni volontarie risoluzione consensuale rapporto di lavoro",
    "busta paga": "cedolino retribuzione compenso mensile",
    "stipendio": "retribuzione compenso lavoro subordinato",
    "ferie": "ferie permessi riposi retribuiti ROL",
    "straordinario": "lavoro straordinario orario supplementare",
    "tfr": "trattamento fine rapporto liquidazione indennità",
    "liquidazione": "trattamento fine rapporto TFR indennità",
    "ccnl": "contratto collettivo nazionale lavoro contrattazione collettiva",
    "sindacato": "organizzazione sindacale contrattazione collettiva diritto sindacale",
    "apprendista": "apprendistato formazione professionalizzante contratto formativo",
    "interinale": "somministrazione lavoro agenzia interinale lavoratore somministrato",
    "co.co.co": "collaborazione coordinata continuativa parasubordinato",
    "collaboratore": "collaborazione coordinata continuativa parasubordinato",
    "preavviso": "periodo preavviso licenziamento dimissioni indennità sostitutiva",
    "periodo di prova": "patto prova periodo prova recesso libero",
    "smart working": "lavoro agile prestazione lavorativa modalità agile",
    "infortunio": "infortunio lavoro malattia professionale sicurezza INAIL",
    "mobbing": "mobbing molestie lavoro demansionamento danno professionale",
    "trasferimento": "trasferimento sede lavoratore art. 2103 codice civile",
