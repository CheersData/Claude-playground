    ...
    <div className={`border-l-2 ${blockColor} bg-[var(--bg-overlay)]/40 rounded-lg overflow-hidden`}>
      ...
      <div className="flex items-start gap-3 px-4 py-3">
        ...
        <div className="flex-shrink-0 flex flex-col items-start gap-2 pt-0.5">
          ...
          {tc.trapType && (
            <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-orange-500/20 text-orange-400 flex items-center gap-1">
        ...
        <div className="flex-shrink-0 flex items-center gap-2">
          ...
          <button
            onClick={handleRun}
            disabled={isRunning}
            className="flex items-center gap-2 px-3 py-2 bg-[#FF6B35]/15 hover:bg-[#FF6B35]/25 disabled:opacity-50 disabled:cursor-not-allowed text-[#FF6B35] rounded-lg text-xs font-medium transition-colors"
          >
            {isRunning ? (
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-xs text-purple-400 uppercase tracking-widest font-medium">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {runAll.active ? (
              <button
                onClick={handleStop}
                className="flex items-center gap-2 px-3 py-2 bg-red-500/15 hover:bg-red-500/25 text-red-400 rounded-lg text-xs font-medium transition-colors border border-red-500/20"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-[#FF6B35]/15 hover:bg-[#FF6B35]/25 disabled:opacity-50 disabled:cursor-not-allowed text-[#FF6B35] rounded-lg text-xs font-medium transition-colors border border-[#FF6B35]/20"
              >
