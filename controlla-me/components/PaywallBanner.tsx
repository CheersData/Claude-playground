  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-3xl border border-accent/30 bg-accent/[0.04] p-8 md:p-10 text-center">
        ...
        {/* Usage bar */}
        <div className="h-[4px] rounded-full bg-white/[0.06] overflow-hidden max-w-[200px] mx-auto mb-6">
          <div
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button
                ...
                disabled={loading !== null}
                className="flex items-center justify-center gap-2 px-6 py-3 rounded-full text-sm font-bold text-white/70 border border-white/[0.15] hover:border-white/40 hover:text-white transition-all disabled:opacity-50"
              >
                {loading === "single" ? (
                  <Loader2 className="w-4 h-4 animate-spin" />
                ) : (
            ...
            <Link
              href="/pricing"
              className="inline-block mt-5 text-xs text-white/30 hover:text-white/50 transition-colors underline underline-offset-4"
            >
              Confronta i piani
            </Link>
          </>
