    ...
    >
      <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <defs>
          ...
          <linearGradient id={`shirt-${variant}`} x1="0" y1="0" x2="0" y2="1">
...
/* ── LEO — Il Catalogatore ── */
/* Short neat hair, round glasses, bow tie, clipboard */
  ...
  return (
    <g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
        ...
        <path d="M50 175 C50 140 70 125 100 120 C130 125 150 140 150 175" fill="none" stroke={color} strokeWidth="1.5" />
        {/* Collar */}
        <path d="M85 125 L100 140 L115 125" fill="none" stroke="white" strokeOpacity="0.4" strokeWidth="2" strokeLinecap="round" />
        {/* Bow tie */}
        <path d="M93 132 L100 136 L107 132 L100 128 Z" fill="white" fillOpacity="0.6" />
      </motion.g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.15 }}>
        ...
        <ellipse cx="100" cy="82" rx="34" ry="38" fill="none" stroke="#D4A574" strokeWidth="0.8" strokeOpacity="0.3" />
        ...
        {/* Lens reflection */}
        <circle cx="82" cy="76" r="3" fill="white" fillOpacity="0.1" />
        <circle cx="110" cy="76" r="3" fill="white" fillOpacity="0.1" />
      ...
      {/* Clipboard — floating beside him */}
      <motion.g
        animate={{ rotate: [-3, 3, -3], y: [0, -3, 0] }}
        transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
        style={{ transformOrigin: "160px 100px" }}
      >
        <rect x="148" y="70" width="28" height="38" rx="3" fill="white" fillOpacity="0.15" stroke={color} strokeWidth="1.5" />
        ...
        {/* Checkmarks */}
        <motion.path d="M154 80 L156 82 L160 77" stroke={color} strokeWidth="1.5" fill="none" strokeLinecap="round"
...
/* ── MARTA — L'Analista ── */
/* Ponytail, sharp eyes, red-tinted, magnifying glass */
  ...
  return (
    <g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.3 }}>
        ...
        <path d="M48 175 C48 138 68 122 100 118 C132 122 152 138 152 175" fill="none" stroke={color} strokeWidth="1.5" />
        {/* V-neck */}
        <path d="M82 122 L100 142 L118 122" fill="#0a0a0a" fillOpacity="0.3" stroke="none" />
      </motion.g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.45 }}>
        ...
        {/* Hair — dark brown, side-swept with ponytail */}
        ...
        <motion.path
          d="M130 60 C145 62 155 72 152 88 C150 80 142 70 130 68 Z"
          fill="#4A2C20"
        ...
        />
        <motion.path
          d="M130 68 C142 70 150 82 148 98 C146 88 140 78 128 76 Z"
          fill="#3D2418"
          animate={{ rotate: [0, 3, 0, -2, 0] }}
          transition={{ duration: 3, repeat: Infinity, ease: "easeInOut", delay: 0.1 }}
          style={{ transformOrigin: "130px 72px" }}
        />
        {/* Hair band */}
        ...
        <motion.g animate={{ scaleY: [1, 1, 0.1, 1, 1] }} transition={{ duration: 5, repeat: Infinity, times: [0, 0.55, 0.6, 0.65, 1] }} style={{ transformOrigin: "100px 78px" }}>
          {/* Eye shapes — slightly angled for sharpness */}
      ...
      {/* Magnifying glass */}
      <motion.g
        animate={{ x: [0, 4, 0, -4, 0], y: [0, -3, 0, 2, 0], rotate: [0, 5, 0, -5, 0] }}
      ...
      >
        ...
        <circle cx="38" cy="88" r="11" fill="white" fillOpacity="0.05" stroke={color} strokeWidth="1" strokeOpacity="0.3" />
        <line x1="50" y1="100" x2="62" y2="112" stroke={color} strokeWidth="3.5" strokeLinecap="round" />
        {/* Glint */}
        <motion.circle cx="32" cy="82" r="3" fill="white" fillOpacity="0.3"
...
/* ── GIULIA — La Giurista ── */
/* Elegant long hair, serious/wise expression, scales of justice */
  ...
  return (
    <g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.6 }}>
        ...
        <path d="M46 175 C46 136 68 120 100 116 C132 120 154 136 154 175" fill="none" stroke={color} strokeWidth="1.5" />
        {/* High collar */}
        <path d="M84 120 C90 126 96 128 100 128 C104 128 110 126 116 120" fill="none" stroke="white" strokeOpacity="0.3" strokeWidth="1.5" />
      </motion.g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.75 }}>
        ...
        {/* Hair — long, elegant, flowing down both sides */}
        <path d="M67 70 C65 44 80 32 100 32 C120 32 135 44 133 70 C133 55 120 38 100 38 C80 38 67 55 67 70 Z" fill="#1A1A2E" />
        {/* Long hair left */}
        <motion.path d="M67 70 C62 80 58 105 60 130 C63 120 65 95 67 80 Z" fill="#1A1A2E"
          animate={{ x: [0, -1, 0, 1, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.path d="M62 80 C58 100 56 125 58 140 C60 130 62 108 64 90 Z" fill="#12122A"
          animate={{ x: [0, -1.5, 0, 1, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 0.2 }}
        />
        {/* Long hair right */}
        <motion.path d="M133 70 C138 80 142 105 140 130 C137 120 135 95 133 80 Z" fill="#1A1A2E"
          animate={{ x: [0, 1, 0, -1, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.path d="M138 80 C142 100 144 125 142 140 C140 130 138 108 136 90 Z" fill="#12122A"
          animate={{ x: [0, 1.5, 0, -1, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 0.2 }}
        />
        {/* Part line */}
        <path d="M100 32 C100 40 98 50 96 58" fill="none" stroke="#12122A" strokeWidth="1" strokeOpacity="0.5" />
        ...
        {/* Eyebrows — straight, intellectual */}
      ...
      <motion.g
        ...
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        style={{ transformOrigin: "164px 68px" }}
      >
        {/* Pillar */}
...
/* ── ENZO — Il Consulente ── */
/* Warm, mature, short beard, wise smile, lightbulb/idea */
  ...
  return (
    <g>
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.9 }}>
        ...
        <path d="M48 175 C48 138 68 122 100 118 C132 122 152 138 152 175" fill="none" stroke={color} strokeWidth="1.5" />
        {/* Lapels */}
        <path d="M86 122 L78 145 L88 138 L100 148 L112 138 L122 145 L114 122" fill="none" stroke="white" strokeOpacity="0.3" strokeWidth="1.2" />
        {/* Tie */}
      ...
      <motion.g animate={{ y: [0, -1.5, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 1.05 }}>
        ...
        {/* Hair — short, slightly wavy, salt & pepper */}
      ...
      >
        ...
        >
          ...
          <circle cx="155" cy="50" r="12" fill={color} fillOpacity="0.05" />
          {/* Bulb shape */}
        ...
        {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => (
          <motion.line
            key={angle}
            x1={155 + 22 * Math.cos((angle * Math.PI) / 180)}
            y1={50 + 22 * Math.sin((angle * Math.PI) / 180)}
            x2={155 + 27 * Math.cos((angle * Math.PI) / 180)}
            y2={50 + 27 * Math.sin((angle * Math.PI) / 180)}
            stroke={color}
            strokeWidth="1.5"
            strokeLinecap="round"
  ...
  return (
    <div className="w-full max-w-[900px]">
      ...
      >
        ...
        <p className="text-base md:text-lg text-white/40 max-w-[520px] mx-auto leading-relaxed">
          Ogni consulente è specializzato in una fase dell&apos;analisi.
        ...
        {agents.map((agent, i) => {
          ...
          return (
            <motion.div
              ...
              className="group relative overflow-hidden bg-white/[0.03] border border-white/[0.06] rounded-3xl p-6 md:p-8 hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-300"
            >
              {/* Background glow */}
              <div
                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                style={{
                  background: `radial-gradient(circle at ${isEven ? "20%" : "80%"} 30%, ${agent.color}08, transparent 60%)`,
                }}
              />
              {/* Side accent */}
              <div
              ...
              {/* Step number */}
              <div
                className="absolute top-5 right-6 text-[11px] font-bold tracking-[2px] uppercase px-3 py-1 rounded-full"
              ...
              {/* Content */}
              <div className={`flex flex-col ${isEven ? "md:flex-row" : "md:flex-row-reverse"} items-center gap-6 md:gap-8`}>
                {/* Avatar */}
                ...
                <div className={`flex-1 ${isEven ? "md:text-left" : "md:text-right"} text-center`}>
                  ...
                  <p className="font-serif italic text-white/50 text-base mb-4">
                    &ldquo;{agent.tagline}&rdquo;
                  </p>

                  {/* What they do — bullet list */}
                  <ul className={`space-y-2 ${isEven ? "md:text-left" : "md:text-right"}`}>
                    {agent.whatHeDoes.map((item, j) => (
                      <motion.li
                        ...
                        className={`flex items-center gap-2.5 text-sm text-white/50 ${isEven ? "" : "md:flex-row-reverse"}`}
                      >
      ...
      >
        {agents.map((agent, i) => (
          <div key={agent.phase} className="flex items-center gap-3">
            ...
            {i < agents.length - 1 && (
              <svg width="20" height="10" viewBox="0 0 20 10" className="text-white/15 shrink-0">
