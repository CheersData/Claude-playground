      ...
      <div className="max-w-[1000px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="inline-flex items-baseline gap-0.5 mb-4">
              <span className="font-serif text-2xl text-white italic">controlla</span>
          ...
          {/* Prodotto */}
          <div>
            <h4 className="text-xs font-bold tracking-[2px] uppercase text-white/50 mb-4">Prodotto</h4>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.href}>
                  <Link href={item.href} className="text-sm text-white/25 hover:text-white/60 transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Legale */}
          <div>
            <h4 className="text-xs font-bold tracking-[2px] uppercase text-white/50 mb-4">Legale</h4>
            <ul className="space-y-2.5">
              {[
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-white/[0.04]">
          ...
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="text-xs text-white/20">Tutti i sistemi operativi</span>
          </div>
        </div>
      </div>
    </footer>
