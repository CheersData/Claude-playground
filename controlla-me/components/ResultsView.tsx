...
export default function ResultsView({
  ...
  return (
    <div className="max-w-[720px] mx-auto px-6 pt-28 pb-20">
      ...
      >
        <div>
          <p className="text-sm text-white/35 mb-1.5">
      ...
      >
        <h3 className="text-[11px] font-bold tracking-[2px] uppercase text-white/35 mb-3">
          Riassunto
        </h3>
      ...
      <motion.div
        ...
        className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 mb-5"
      >
        <h3 className="text-[11px] font-bold tracking-[2px] uppercase text-white/35 mb-4">
          Rischi identificati
        </h3>
          ...
          <div className="flex flex-col gap-3">
            {result.deadlines.map((d, i) => (
              ...
              >
                ...
                <span className="text-sm text-white/60">{d.action}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      >
        ...
        <button className="px-7 py-3 rounded-full text-sm font-medium text-white/70 border border-white/[0.15] hover:border-white/40 hover:text-white transition-all">
