...
const testimonials = [
  ...
  },
  {
    ...
    location: "Roma",
    role: "Freelancer",
    text: "Il mio nuovo cliente mi aveva mandato un contratto di collaborazione. Advisor mi ha detto chiaramente: 'Non firmare, il patto di non concorrenza e' eccessivo.' Aveva ragione.",
    stars: 5,
  ...
  },
  {
    ...
    location: "Napoli",
    role: "Consumatore",
    text: "Una bolletta del gas con addebiti strani. Ho caricato il PDF e in 30 secondi Understand ha trovato 3 servizi mai richiesti. Ho ottenuto il rimborso completo.",
    stars: 5,
  ...
  },
  {
    ...
    location: "Torino",
    role: "Acquirente",
    text: "Preliminare di vendita per la mia prima casa. Investigate ha trovato che mancava la menzione di un vincolo urbanistico. Il notaio ha confermato tutto.",
    stars: 5,
